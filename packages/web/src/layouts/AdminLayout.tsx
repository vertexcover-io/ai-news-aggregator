    ...
    <div>
      <header className="flex items-center justify-between px-4 py-2 border-b">
        <nav className="flex items-center gap-4">
          ...
          <Link to="/admin/incidents" className="font-mono text-xs uppercase tracking-widest text-neutral-500 hover:text-neutral-900 min-h-[44px] inline-flex items-center">Incidents</Link>
