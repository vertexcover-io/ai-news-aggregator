// This file is auto-managed alongside the user_settings.ranking_prompt seed.
// If you edit this constant, you MUST update packages/shared/src/db/migrations/0026_*.sql
// to match byte-for-byte. The drift test enforces this.
export const DEFAULT_RANKING_PROMPT = `The reader is a software developer, tech lead, engineering manager, or founder who works with developers. They care about AI-assisted software development, coding agents, agentic AI tooling, evaluations, observability, infrastructure, reliability, and practical engineering workflows. They open this digest to find stories they can use themselves or share with their teams.
...
Source neutrality rule: Blog posts have no comments by source design. Do not penalize items that lack discussion. Use comments as extra context when present, never as a scoring requirement.
