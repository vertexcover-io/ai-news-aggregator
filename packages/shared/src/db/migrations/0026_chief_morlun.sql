ALTER TABLE "user_settings" ADD COLUMN "ranking_prompt" text;--> statement-breakpoint
UPDATE "user_settings" SET "ranking_prompt" = $prompt$The reader is a software developer, tech lead, engineering manager, or founder who works with developers. They care about AI-assisted software development, coding agents, agentic AI tooling, evaluations, observability, infrastructure, reliability, and practical engineering workflows. They open this digest to find stories they can use themselves or share with their teams.
