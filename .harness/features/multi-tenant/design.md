...
Static HTML mockups of every new surface live in `.harness/features/multi-tenant/mocks/` (open `index.html`), built on the existing "Daily Read" theme tokens. They are the visual contract for the build.
